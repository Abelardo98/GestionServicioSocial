<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" 
    CodeBehind="ReportePresentacionInterno2.aspx.cs" Inherits="GestionServicioSocial.ReportePrecentacionInterno2" %>
<%@ Register assembly="CrystalDecisions.Web, Version=13.0.4000.0, Culture=neutral, 
    ...
    <article style="padding-left:150px">
        ...
        <div style="padding-left:150px">
            <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" AutoDataBind="True" GroupTreeImagesFolderUrl=""
                Height="1202px" ReportSourceID="CrystalReportSource2" ToolbarImagesFolderUrl="" 
