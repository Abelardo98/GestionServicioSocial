...
{
    public partial class EditarServicoAlumno : System.Web.UI.Page
    {
        DataTable dt;
        SqlDataAdapter da;
        ...
        public void llenarDatos()
        {
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                txtCopiaNombre.Text = HttpUtility.HtmlDecode(row.Cells[37].Text);
                txtCopiaPuesto.Text = HttpUtility.HtmlDecode(row.Cells[38].Text);
