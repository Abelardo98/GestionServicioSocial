...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <header class="auto-style2">
        ...
        &nbsp; <asp:LinkButton ID="BtnCartaP" runat="server" Font-Bold="True" Font-Size="Smaller" OnClick="BtnCartaP_Click">Carta Provisional</asp:LinkButton>
        &nbsp;
...
<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel2">¿Esta seguro de querer eliminar el numero de control?</h5>
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <header style="text-align: center; border-top-width: medium; " class="auto-style5"><h3 class="auto-style4">DATOS DE ALUMNOS REGISTRADOS PARA REALIZAR SERVICIO SOCIAL</h3></header>
