<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="EditarResidenciaAlumno.aspx.cs" Inherits="GestionServicioSocial.EditarResidenciaAlumno" %>
        ...
        <table class="auto-style12">
            <tr>
                ...
                <td class="auto-style8">
                    ...
                    <asp:TextBox ID="txtCopiaNombre" runat="server" Width="405px" value="Archivo" onkeyup="javascript:this.value=this.value.toUpperCase();"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td class="auto-style7">
